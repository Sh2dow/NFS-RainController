...
public:
    ...
    static void UpdateD3DTransform(D3DTRANSFORMSTATETYPE state, const D3DMATRIX* mat);
    static bool GetD3DViewProj(D3DXMATRIX& view, D3DXMATRIX& proj);
    static bool GetD3DProj(D3DXMATRIX& proj);
