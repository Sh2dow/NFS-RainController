...
void RainConfigController::LoadOnStartup()
{
    ...
    iniPath = iniPath.substr(0, iniPath.find_last_of("\\/")) + "\\scripts\\NFS.WeatherMod.ini";
...
void RainConfigController::Load()
{
    ...
    toggleKey = iniReader.ReadInteger("Precipitation", "ToggleKey", VK_F4);
    ...
    precipitationConfig.alpha2DRainMin = iniReader.ReadInteger("Precipitation", "Alpha2DRainMin", 0);
    precipitationConfig.alpha2DRainMax = iniReader.ReadInteger("Precipitation", "Alpha2DRainMax", 0);
    ...
    precipitationConfig.alphaBlendNearValue = iniReader.ReadInteger("Precipitation", "AlphaBlendNearValue", 0);
    precipitationConfig.alphaBlendMidValue = iniReader.ReadInteger("Precipitation", "AlphaBlendMidValue", 0);
    precipitationConfig.alphaBlendFarValue = iniReader.ReadInteger("Precipitation", "AlphaBlendFarValue", 0);
